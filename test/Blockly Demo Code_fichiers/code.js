...
Code.tabClick = function(clickedName) {
  ...
  // tab python
  if (document.getElementById('tab_python').classList.contains('tabon')) {
    var pythonTextarea = document.getElementById('content_python');
    console.log(pythonTextarea)
    // var xmlText = xmlTextarea.value;
    // var xmlDom = null;
    // try {
    //   xmlDom = Blockly.Xml.textToDom(xmlText);
...
document.write('<script src="Blockly Demo Code_fichiers/' + Code.LANG + '_002.js"></script>\n');
// Load Blockly's language strings.
document.write('<script src="../ext_lib/blockly/msg/js/' + Code.LANG + '.js"></script>\n');
