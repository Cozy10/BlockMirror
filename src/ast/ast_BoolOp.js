...
var BOOLOPS_BLOCKLY_DISPLAY = PyBlock.BOOLOPS.map(
    boolop => [boolop[0], boolop[1]]
);
var BOOLOPS_BLOCKLY_GENERATE = {};
PyBlock.BOOLOPS.forEach(function (boolop) {
...
PyBlock.prototype['ast_BoolOp'] = function (node, parent) {
    ...
    for (var i = 1; i < values.length; i += 1) {
        result_block = PyBlock.create_block("logic_operation", node.lineno, "bool", {
